...
void main()
{
    ...
    // Always render sun disk regardless of zenith angle, but scale by atmospheric extinction
    float sunDiskIntensity = sunDirection.y < 0.0 ? sunIntensityFactor * 0.1 : sunE;
    L0 += sunDiskIntensity * 19000.0 * Fex * sundisk;
