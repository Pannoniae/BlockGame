...
public class Torch : Block {
    ...
    public override void render(BlockRenderer br, int x, int y, int z, List<BlockVertexPacked> vertices) {
        ...
        switch (attachment) {
            case GROUND:
                BlockRenderer.renderTorchCube(br, x, y, z, vertices, 7 / 16f, 0f, 7 / 16f, 9 / 16f, 10 / 16f, 9 / 16f,
                    su0, sv0, su1, sv1, tu0, tv0, tu1, tv1, bu0, bv0, bu1, bv1);
                break;

            case WEST_WALL:
                BlockRenderer.renderTorchCube(br, x, y, z, vertices, 0f, 3 / 16f, 7 / 16f, 2 / 16f, 13 / 16f, 9 / 16f,
                    su0, sv0, su1, sv1, tu0, tv0, tu1, tv1, bu0, bv0, bu1, bv1,
                    new Vector3(0, 0, 1), -tiltAngle, new Vector3(x + 0f, y + 2 / 16f, z + 8 / 16f));
                break;

            case EAST_WALL:
                BlockRenderer.renderTorchCube(br, x, y, z, vertices, 14 / 16f, 3 / 16f, 7 / 16f, 1f, 13 / 16f, 9 / 16f,
                    su0, sv0, su1, sv1, tu0, tv0, tu1, tv1, bu0, bv0, bu1, bv1,
                    new Vector3(0, 0, 1), tiltAngle, new Vector3(x + 1f, y + 2 / 16f, z + 8 / 16f));
                break;

            case SOUTH_WALL:
                BlockRenderer.renderTorchCube(br, x, y, z, vertices, 7 / 16f, 3 / 16f, 0 / 16f, 9 / 16f, 13 / 16f, 2 / 16f,
                    su0, sv0, su1, sv1, tu0, tv0, tu1, tv1, bu0, bv0, bu1, bv1,
                    new Vector3(1, 0, 0), tiltAngle, new Vector3(x + 8 / 16f, y + 2 / 16f, z + 0f));
                break;

            case NORTH_WALL:
                BlockRenderer.renderTorchCube(br, x, y, z, vertices, 7 / 16f, 3 / 16f, 14 / 16f, 9 / 16f, 13 / 16f, 16 / 16f,
                    su0, sv0, su1, sv1, tu0, tv0, tu1, tv1, bu0, bv0, bu1, bv1,
