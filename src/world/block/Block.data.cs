...
public partial class Block {
    ...
    public static Fence REDWOOD_FENCE;
    ...
    public static void preLoad() {
        ...
        MUSHROOM_BROWN = register("brownMushroom", new Leaves("BrownMushroom"));
        ...
        optionalTool[MUSHROOM_BROWN.id] = false;

        MUSHROOM_RED = register("redMushroom", new Leaves("RedMushroom"));
        ...
        optionalTool[MUSHROOM_RED.id] = false;

        MUSHROOM_GREEN = register("greenMushroom", new Leaves("GreenMushroom"));
        ...
        MUSHROOM_GREEN.material(Material.FOOD);
        ...
        REDWOOD_FENCE = register("redwoodFence", new Fence("Redwood Fence", 4));
        REDWOOD_FENCE.material(Material.WOOD);
        REDWOOD_FENCE.setFlammable(30);
