...
public class Water : Block {
    ...
    public override void render(BlockRenderer br, int x, int y, int z, List<BlockVertexPacked> vertices) {
        ...
        var texMin =
            (level > 0 || falling)
                ? uvs[1]
                : uvs[0]; // flowing texture for levels > 0 or falling water, still texture for source
        var texMax = texMin + 1;
        ...
        // max possible height for UV calculation
            ...
            if (cullFace(br, x, y, z, d)) {
                ...
                switch (d) {
                    case RawDirection.WEST:
                        br.vertex(x + 0, y + h01, z + 1, uMin, vMax - (vMax - vMin) * (h01));
                        br.vertex(x + 0, y + 0, z + 1, uMin, vMax);
                        br.vertex(x + 0, y + 0, z + 0, uMax, vMax);
                        br.vertex(x + 0, y + h00, z + 0, uMax, vMax - (vMax - vMin) * (h00));
                        break;
                    case RawDirection.EAST:
                        br.vertex(x + 1, y + h10, z + 0, uMin, vMax - (vMax - vMin) * (h10));
                        br.vertex(x + 1, y + 0, z + 0, uMin, vMax);
                        br.vertex(x + 1, y + 0, z + 1, uMax, vMax);
                        br.vertex(x + 1, y + h11, z + 1, uMax, vMax - (vMax - vMin) * (h11));
                        break;
                    case RawDirection.SOUTH:
                        br.vertex(x + 0, y + h00, z + 0, uMin, vMax - (vMax - vMin) * (h00));
                        br.vertex(x + 0, y + 0, z + 0, uMin, vMax);
                        br.vertex(x + 1, y + 0, z + 0, uMax, vMax);
                        br.vertex(x + 1, y + h10, z + 0, uMax, vMax - (vMax - vMin) * (h10));
                        break;
                    case RawDirection.NORTH:
                        br.vertex(x + 1, y + h11, z + 1, uMin, vMax - (vMax - vMin) * (h11));
                        br.vertex(x + 1, y + 0, z + 1, uMin, vMax);
                        br.vertex(x + 0, y + 0, z + 1, uMax, vMax);
                        br.vertex(x + 0, y + h01, z + 1, uMax, vMax - (vMax - vMin) * (h01));
                        break;
