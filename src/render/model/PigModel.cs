...
public class PigModel : EntityModel {

    public const int xs = 64;
    public const int ys = 36;
    ...
    public PigModel(int l) {

        head = new Cube().pos(0, l + 4, 12).off(-3, 0, -4).ext(6, 6, 6).tex(0, 0).gen(xs, ys);
        body = new Cube().pos(0, l + 8, 0).off(-5, -8, -8).ext(10, 8, 16).tex(12, 12).gen(xs, ys);

        frontRightLeg = new Cube().pos(-2.5f, l, 6f).off(-1.5f, -l, -1.5f).ext(3, l, 3).tex(0, 12).gen(xs, ys);
        frontLeftLeg = new Cube().pos(2.5f, l, 6f).off(-1.5f, -l, -1.5f).ext(3, l, 3).tex(0, 12).gen(xs, ys);
        backLeftLeg = new Cube().pos(2.5f, l, -4.5f).off(-1.5f, -l, -1.5f).ext(3, l, 3).tex(0, 12).gen(xs, ys);
        backRightLeg = new Cube().pos(-2.5f, l, -4.5f).off(-1.5f, -l, -1.5f).ext(3, l, 3).tex(0, 12).gen(xs, ys);
    }
