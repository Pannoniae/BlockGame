...
public static class Loc {
    private static readonly Dictionary<string, string> strings = new() {
        ...
        ["generator.v2"] = "Alpine",
        ["generator.v2.tooltip"] = "Not as good as the nostalgic one, but still pretty good, eh?",
        ["generator.new"] = "Plains",
        ["generator.new.tooltip"] = "Varied terrain with mountains, plains and plenty of space for building.",
        ["generator.perlin"] = "Perlin",
        ["generator.perlin.tooltip"] = "Chaotic floating islands and fragmented terrain everywhere.",
