...
namespace Silk.NET.Windowing.Sdl
{
    ...
    public static class SdlWindowing
    {
        ...
        // SDL_SysWMinfo removed in SDL3
        // use platform-specific APIs directly or SDL3.SDL_GetWindowProperties() for properties!

        public static unsafe SDL_Window* GetHandle(IView view)
